...
comstr=$(echo "(load-file \"$HOME/.dotfiles/config/emacs\")")
cat ~/.emacs | grep "$comstr" >> /dev/null && echo "~/.emacs already include ~/.dotfiles/config/bashrc" || (echo "Modifying ~/.emacs" && echo $comstr >> ~/.emacs)
